...
print_zcall pi (ZFunc2 ZFirst) (ZTuple[a,b]) = print_unaryop pi (binary_op ZFirst) (ZTuple[a,b])
print_zcall pi (ZFunc2 ZSecond) (ZTuple[a,b]) = print_unaryop pi (binary_op ZSecond) (ZTuple[a,b])
