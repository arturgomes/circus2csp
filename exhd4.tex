...
RaiseAlarm~\circdef~ \lschexpract [~\Delta~HDState | alarm'~=~ENABLED ~]\rschexpract \circseq (produceAlarmSound \then \Skip)\\
...
\begin{circusaction}
  ...
  \\\t2 \extchoice \lschexpract \lnot PreR1 \rschexpract \circseq Wait(CheckInterval) \circseq R1
\end{circusaction}
%</ZR1>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR3 \rschexpract \circseq Wait(CheckInterval)\circseq R3
\end{circusaction}
%</ZR3>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR4 \rschexpract \circseq Wait(CheckInterval)\circseq R4
\end{circusaction}
%</ZR4>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR5 \rschexpract \circseq Wait(CheckInterval)\circseq R5
\end{circusaction}
%</ZR5>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR6 \rschexpract \circseq Wait(CheckInterval)\circseq R6
\end{circusaction}
%</ZR6>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR7 \rschexpract \circseq Wait(CheckInterval)\circseq R7
\end{circusaction}
%</ZR7>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR8 \rschexpract \circseq Wait(CheckInterval)\circseq R8
\end{circusaction}
%</ZR8>
...
\begin{circusaction}
  ...
  \\\t2 \extchoice \lschexpract \lnot PreR9 \rschexpract \circseq Wait(CheckInterval) \circseq R9
\end{circusaction}
%</ZR9>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR10 \rschexpract \circseq Wait(CheckInterval)\circseq R10
\end{circusaction}
%</ZR10>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR11 \rschexpract \circseq Wait(CheckInterval)\circseq R11
\end{circusaction}
%</ZR11>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR12 \rschexpract \circseq Wait(CheckInterval)\circseq R12
\end{circusaction}
%</ZR12>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR13 \rschexpract \circseq Wait(CheckInterval)\circseq R13
\end{circusaction}
%</ZR13>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR14 \rschexpract \circseq Wait(CheckInterval)\circseq R14
\end{circusaction}
%</ZR14>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR15 \rschexpract \circseq Wait(CheckInterval)\circseq R15
\end{circusaction}
%</ZR15>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR17 \rschexpract \circseq Wait(CheckInterval)\circseq R17
\end{circusaction}
%</ZR17>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR18 \rschexpract \circseq Wait(CheckInterval)\circseq R18
\end{circusaction}
%</ZR18>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR19 \rschexpract \circseq Wait(CheckInterval)\circseq R19
\end{circusaction}
%</ZR19>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR20 \rschexpract \circseq Wait(CheckInterval)\circseq R20
\end{circusaction}
%</ZR20>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR21 \rschexpract \circseq Wait(CheckInterval)\circseq R21
\end{circusaction}
%</ZR21>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR22 \rschexpract \circseq Wait(CheckInterval)\circseq R22
\end{circusaction}
%</ZR22>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR23 \rschexpract \circseq Wait(CheckInterval)\circseq R23
\end{circusaction}
%</ZR23>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR2832 \rschexpract \circseq Wait(CheckInterval)\circseq R2832
\end{circusaction}
%</ZR2832>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR33 \rschexpract \circseq Wait(CheckInterval)\circseq R33
\end{circusaction}
%</ZR33>
%<*ZR34>
\begin{schema}{PreR34}
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR34 \rschexpract \circseq Wait(CheckInterval)\circseq R34
\end{circusaction}
%</ZR34>
...
\begin{circusaction}
  ...
  \t2 \extchoice \lschexpract \lnot PreR36 \rschexpract \circseq Wait(CheckInterval)\circseq R36
\end{circusaction}
%</ZR36>
