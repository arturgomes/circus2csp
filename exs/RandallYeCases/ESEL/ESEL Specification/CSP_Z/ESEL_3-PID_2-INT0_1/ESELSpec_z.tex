...
\begin{zed}
	Controller\_AssgnOp0 \defs [~  \Delta Controller\_State | Controller\_response' =~\emptyset \land Controller\_pumap' = Controller\_pumap \land Controller\_ppmap' = Controller\_ppmap  ~]
\end{zed}
