...
\begin{circus}
  ...
  \circchannel inputOfSetHeparinParameters
\end{circus}
%</zedtypes>
...
\begin{circus}%
  ...
  Wait~\circdef~ \circvar n : NatValue \circspot
   ...
   \circfi\\
    ...
    senBloodFlowInEBC?bloodFlowInEBC \then SensorReadings\\
...
\also BloodLines~\circdef~setBloodLines \then \Skip
...
%((
((MainTherapy \interleave  SoftwareRequirements) \interleave SensorReadings)
