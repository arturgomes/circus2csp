...
\end{circus}
\begin{circus}
  \circchannel inputOfSetRinsingParameters~:~NatValue \cross NatValue \cross NatValue \cross NatValue \cross NatValue \cross NatValue\\
  \circchannel inputOfSetDFParameters~:~NatValue \cross BUTTON \cross NatValue\cross NatValue \cross NatValue\\
  \circchannel inputOfSetUFParameters~:~NatValue \cross NatValue\cross NatValue\cross NatValue\\
  \circchannel inputOfSetPressureParameters~:~NatValue \cross NatValue \cross BUTTON \cross NatValue\cross BUTTON\\
  \circchannel inputOfSetHeparinParameters~:~TIME \cross NatValue \cross NatValue \cross BUTTON \cross NatValue\\
\end{circus}
%</zedtypes>
