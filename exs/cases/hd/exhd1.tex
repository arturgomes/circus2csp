...
SensorReadings ~\circdef~
  ...
  R3~\circdef~
    (\lcircguard hdMachineState~=~\{initPhase\}\land bloodFlowInEBC < ((dfFlow * 1) \div 1) \rcircguard ~\circguard~RaiseAlarm)\\
    \t2\extchoice\lcircguard \lnot (hdMachineState~=~\{initPhase\}\land bloodFlowInEBC < ((dfFlow * 1) \div 1)) \rcircguard ~\circguard ( R3)
