...
"HAChrono = AChrono \{|time, tick|}"\\
 \also "HChrono = Chrono \{|time, tick|}"\\
 \also "assert AChrono :[deterministic [FD]]"\\
 ...
 \also "HWakeUp = WakeUp \ {| radioOn |}"\\
 \also "HWakeUpOK = WakeUpOK \ {| radioOn |}"\\
 \also "assert HAChrono [FD= HWakeUp"\\
 \also "assert HWakeUp [FD= HAChrono"\\
 \also "assert WakeUpOK :[deterministic [FD]]"\\
 \also "assert HWakeUpOK [FD= AChrono"\\
 \also "assert AChrono [FD= HWakeUpOK"\\
 \also "-- Testing the behavior of the WakeUpOk process"\\
 \also "TestWU = (time -> out.(1,1) -> SKIP) [] (snooze -> SKIP)"\\
 \also "TestWU1 = (time -> out.(1,1) ->  snooze -> SKIP)"\\
 \also "assert WakeUpOK\{|tick|} [FD= TestWU"\\
 \also "assert WakeUpOK\{|tick|} [FD= TestWU1"
\end{assert}
