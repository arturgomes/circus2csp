...
\isakeyword{imports}\ AST\ Prelude\isanewline
\isakeyword{begin}%
\endisatagtheory
{\isafoldtheory}%
%
...
\ subset\isanewline
\isakeyword{where}\isanewline
\ \ {\isachardoublequoteopen}subset\ xs\ ys\ {\isacharequal}\ list{\isacharunderscore}all\ {\isacharparenleft}{\isacharpercent}\ arg{\isadigit{0}}\ {\isachardot}\ member\ arg{\isadigit{0}}\ ys{\isacharparenright}\ xs{\isachardoublequoteclose}\isanewline
\isanewline
%
\isadelimtheory
\isanewline
