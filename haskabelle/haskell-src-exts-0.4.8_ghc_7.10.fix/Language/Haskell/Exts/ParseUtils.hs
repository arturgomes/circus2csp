...
checkSimple _kw (TyInfix (TyVar a) (UnQual t) (TyVar b)) xs = return (t,a:b:xs)
checkSimple _kw (TyCon (UnQual t))   xs = return (t,xs)
-- checkSimple _kw (TyKind t k) = ...
...
-- Cases used solely for patterns. Not to be left in the final tree.
...
-- Dashed vars, an artifact of HSX. Not to be left in the final tree.
    | DVar [Name]              -- ^ dashed variables
