...
lemma omega_CSPSkip: "omega_CAction lst CSPSkip = (\<Omega> CSPSkip)"
  by simp
lemma omega_CSPChaos:"omega_CAction lst CSPChaos = (\<Omega> CSPChaos)"
  by simp

lemma omega_CSPStop: "omega_CAction lst CSPStop = (\<Omega> CSPStop)"
  by simp

lemma omega_CAssign:"omega_CAction lst (CActionCommand (CAssign va vb)) = (\<Omega> (CActionCommand (CAssign va vb)))"
  by simp


lemma omega_CAssumpt:"omega_CAction lst (CActionCommand (CAssumpt va vb vc)) = (\<Omega> (CActionCommand (CAssumpt va vb vc)))"
  by simp


lemma omega_CAssumpt1:"omega_CAction lst (CActionCommand (CAssumpt1 va vb)) = (\<Omega> (CActionCommand (CAssumpt1 va vb)))"
  by simp


lemma omega_CIf:"omega_CAction lst (CActionCommand (CIf a)) = (\<Omega> (CActionCommand (CIf a)))"
  by simp


lemma omega_CPrefix:"omega_CAction lst (CActionCommand (CPrefix va vb)) = (\<Omega> (CActionCommand (CPrefix va vb)))"
  by simp


lemma omega_CPrefix1: "omega_CAction lst (CActionCommand (CPrefix1 va)) = (\<Omega> (CActionCommand (CPrefix1 va)))"
  by simp


lemma omega_CResDecl: "omega_CAction lst (CActionCommand (CResDecl va vb)) = (\<Omega> (CActionCommand (CResDecl va vb)))"
  by simp


lemma omega_CValDecl: "omega_CAction lst (CActionCommand (CValDecl va vb)) = (\<Omega> (CActionCommand (CValDecl va vb)))"
  by simp


lemma omega_CVarDecl: "omega_CAction lst (CActionCommand (CVarDecl va vb)) = (\<Omega> (CActionCommand (CVarDecl va vb)))"
  by simp


lemma omega_CVResDecl: "omega_CAction lst (CActionCommand (CVResDecl va vb)) = (\<Omega> (CActionCommand (CVResDecl va vb)))"
  by simp


lemma omega_CActionName: "omega_CAction lst (CActionName v) = (\<Omega> (CActionName v))"
  by simp


lemma omega_CActionSchemaExpr: "omega_CAction lst (CActionSchemaExpr v) = (\<Omega> (CActionSchemaExpr v))"
  by simp


lemma omega_CSPCommActionChanDotExp: "omega_CAction lst (CSPCommAction (ChanComm vb (ChanDotExp vc # ve)) va) = (\<Omega> (CSPCommAction (ChanComm vb (ChanDotExp vc # ve)) va))"
  by simp

lemma omega_CSPCommActionChanInp: "omega_CAction lst (CSPCommAction (ChanComm vb (ChanInp vc # ve)) va) = (\<Omega> (CSPCommAction (ChanComm vb (ChanInp vc # ve)) va))"
  by simp

lemma omega_CSPCommActionChanInpPred: "omega_CAction lst (CSPCommAction (ChanComm vb (ChanInpPred v vc # ve)) va) = (\<Omega> (CSPCommAction (ChanComm vb (ChanInpPred v vc # ve)) va))"
  by simp

lemma omega_CSPCommActionChanGenComm: "omega_CAction lst (CSPCommAction (ChanGenComm vb vc vd) va) = (\<Omega> (CSPCommAction (ChanGenComm vb vc vd) va))"
  by simp


lemma omega_CSPExtChoice: "omega_CAction lst (CSPExtChoice v va) = (\<Omega> (CSPExtChoice v va))"
  by simp


lemma omega_CSPGuard: "omega_CAction lst (CSPGuard v va) = (\<Omega> (CSPGuard v va))"
  by simp


lemma omega_CSPInterleave: "omega_CAction lst (CSPInterleave v va) = (\<Omega> (CSPInterleave v va))"
  by simp


lemma omega_CSPNSInter: "omega_CAction lst (CSPNSInter v va vb vc) = (\<Omega> (CSPNSInter v va vb vc))"
  by simp


lemma omega_CSPNSParal: "omega_CAction lst (CSPNSParal v va vb vc vd) = (\<Omega> (CSPNSParal v va vb vc vd))"
  by simp


lemma omega_CSPParAction: "omega_CAction lst (CSPParAction v va) = (\<Omega> (CSPParAction v va))"
  by simp


lemma omega_CSPParal: "omega_CAction lst (CSPParal v va vb) = (\<Omega> (CSPParal v va vb))"
  by simp


lemma omega_CSPRenAction: "omega_CAction lst (CSPRenAction v va) = (\<Omega> (CSPRenAction v va))"
  by simp


lemma omega_CSPRepExtChoice: "omega_CAction lst (CSPRepExtChoice v va) = (\<Omega> (CSPRepExtChoice v va))"
  by simp


lemma omega_CSPRepIntChoice: "omega_CAction lst (CSPRepIntChoice v va) = (\<Omega> (CSPRepIntChoice v va))"
  by simp


lemma omega_CSPRepInterl: "omega_CAction lst (CSPRepInterl v va) = (\<Omega> (CSPRepInterl v va))"
  by simp


lemma omega_CSPRepParal: "omega_CAction lst (CSPRepInterlNS v va vb) = (\<Omega> (CSPRepInterlNS v va vb))"
  by simp
...
lemma omega_CSPRepParalNS: "omega_CAction lst (CSPRepParalNS v va vb vc) = (\<Omega> (CSPRepParalNS v va vb vc))"
  by simp


lemma omega_CSPRepSeq: "omega_CAction lst (CSPRepSeq v va) = (\<Omega> (CSPRepSeq v va))"
  by simp


lemma omega_CSPUnParAction: "omega_CAction lst (CSPUnParAction v va vb) = (\<Omega> (CSPUnParAction v va vb))"
  by simp
...
lemma "omega_CAction lst a = (\<Omega> a)"
    proof (cases a)
      assume "\<And>x1. a = CActionSchemaExpr x1"
